    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-primary badge-pill" href="<?php echo e(route('tentang_program.create')); ?>"><i class="zmdi zmdi-plus"></i> Tambah</a>
        </div>
      </h2>
      <div class="card-body">
        <table id="myTable" class="table table-responsive table-hover table-bordered">
          ...
          <tbody>
            <?php $nomor = 1; ?>
            <?php $no = 1; ?>
            <?php $__currentLoopData = $tentang_program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($no++); ?></td>
              ...
              <td>
                <a class="btn btn-xs btn-outline-warning badge-pill" href="<?php echo e(route('tentang_program.edit',$data->id)); ?>"><i class="zmdi zmdi-edit"></i> Ubah</a>
                <form method="post" action="<?php echo e(route('tentang_program.destroy',$data->id)); ?>">
