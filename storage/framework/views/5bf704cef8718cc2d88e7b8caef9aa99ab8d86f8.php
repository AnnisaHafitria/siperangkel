    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-outline-dark btn-xs badge-pill" href="<?php echo e(route('barang.index')); ?>"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="<?php echo e(route('barang.store')); ?>" method="post" id="insert_form">
            ...
            <center>
              <table id="item_table" class="table table-hover table-bordered">
                <tr id="last" align="center">
                  <th style="background-color:#2196F3"><font color="white">Nama Barang</th>
                  <th style="background-color:#2196F3"><font color="white">Persediaan</th>
                  <th style="background-color:#2196F3"><font color="white">Satuan</th>
                  <th style="background-color:#2196F3"><font color="white">Kondisi</th>
...
<script>
  //multiple insert
    function addrow(){
      ...
      html +='<td><input type="number" name="persediaan[]" class="form-control"/></td>';
      html +='<td><input type="text" name="satuan[]" class="form-control"/></td>';
      html +='<td><input type="text" name="kondisi[]" class="form-control"/></td>';
