    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-primary badge-pill" href="<?php echo e(route('testimoni.create')); ?>"><i class="zmdi zmdi-plus"></i> Tambah</a>
        </div>
      </h2>
      <div class="card-body">
        <table id="myTable" class="table table-responsive table-hover table-bordered">
          <thead class="thead-default" style="background-color:#2196F3">
            <tr>
              ...
              <th><font face color="white">Jumlah</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-xs btn-outline-warning badge-pill" href="<?php echo e(route('testimoni.edit',$data->id)); ?>"><i class="zmdi zmdi-edit"></i> Ubah</a>
                <form method="post" action="<?php echo e(route('testimoni.destroy',$data->id)); ?>">
