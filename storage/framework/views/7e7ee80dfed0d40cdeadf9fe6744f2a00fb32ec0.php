...
<?php echo $__env->make('master.blok._modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
  ...
  var url = {
      list: '<?php echo e(url('list/master/blok')); ?>',
      action: '<?php echo e(url('action/master/blok')); ?>'
  }
