    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-danger" href="<?php echo e(route('pengembalian.export')); ?>"><i class="zmdi zmdi-square-down"></i> PDF</a>
          <a class="btn btn-xs btn-success" href="<?php echo e(route('pengembalian.eksport')); ?>"><i class="zmdi zmdi-download"></i> Excel</a>
        </div>
      </h2>
      <div class="card-body">
