    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-dark badge-pill" href="<?php echo e(route('peminjaman.index')); ?>"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="<?php echo e(route('peminjaman.update',$peminjaman->id)); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="jadwal" value="<?php echo e($peminjaman->jadwal); ?>" class="form-control" readonly>
          </div>
          <div class="form-group">
