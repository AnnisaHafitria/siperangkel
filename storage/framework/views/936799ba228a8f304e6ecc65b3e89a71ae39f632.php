    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-primary badge-pill" href="<?php echo e(route('anggota.create')); ?>"><i class="zmdi zmdi-accounts-add"></i> Tambah</a>
          <a class="btn btn-xs btn-outline-danger badge-pill" href="<?php echo e(route('anggota.eksport')); ?>"><i class="zmdi zmdi-square-down"></i> PDF</a>
          <a class="btn btn-xs btn-outline-success badge-pill" href="<?php echo e(route('anggota.export')); ?>"><i class="zmdi zmdi-download"></i> Excel</a>
        </div>
      </h2>
      <div class="card-body">
        <table id="myTable" class="table table-responsive table-hover table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-xs btn-outline-warning badge-pill" href="<?php echo e(route('anggota.edit',$data->id)); ?>"><i class="zmdi zmdi-edit"></i> Ubah</a>
                <form method="post" action="<?php echo e(route('anggota.destroy',$data->id)); ?>">
