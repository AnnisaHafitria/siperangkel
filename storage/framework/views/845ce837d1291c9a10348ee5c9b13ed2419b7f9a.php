    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-dark badge-pill" href="<?php echo e(route('anggota.index')); ?>"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="<?php echo e(route('anggota.update',$anggota->id)); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="number" name="nope" value="<?php echo e($anggota->nope); ?>" class="form-control number_only" required>
          </div>
          <div class="form-group">
