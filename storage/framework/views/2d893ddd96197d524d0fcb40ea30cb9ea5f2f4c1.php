    ...
    <div class="login">
      ...
      <div class="login__block active" id="l-login">
        ...
        <form action="<?php echo e(route('login')); ?>" method="post">
          ...
          <div class="login__block__body">
            ...
            <button  type="submit" class="btn btn login__block__btn"><i class="zmdi zmdi-square-right"></i> Masuk</button>
          </div>
        </form>
      </div>
      <!-- Register -->
      <div class="login__block" id="l-register">
        ...
        <form action="<?php echo e(route('register')); ?>" method="POST" id="registrasi">
          ...
          <div class="login__block__body">
            ...
            <button type="submit" class="btn btn login__block__btn"><i class="zmdi zmdi-check-circle"></i> Daftar</button>
          </div>
        </form>
      </div>
      <!-- Forgot Password -->
      <div class="login__block" id="l-forget-password">
        ...
        <div class="login__block__body">
          ...
          <button href="index-2.html" class="btn btn login__block__btn"><i class="zmdi zmdi-check-all"></i> Konfirmasi</button>
        </div>
      </div>
    </div>
