    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-primary badge-pill" href="<?php echo e(route('peminjaman.create')); ?>"><i class="zmdi zmdi-collection-plus"></i> Tambah</a>
          <a class="btn btn-xs btn-outline-danger badge-pill" href="<?php echo e(route('peminjaman.expor')); ?>"><i class="zmdi zmdi-square-down"></i> PDF</a>
          <a class="btn btn-xs btn-outline-success badge-pill" href="<?php echo e(route('peminjaman.ekspor')); ?>"><i class="zmdi zmdi-download"></i> Excel</a>
        </div>
      </h2>
      <div class="card-body">
        <table id="myTable" class="table table-hover table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-xs btn-outline-secondary badge-pill" href="<?php echo e(route('peminjaman.show',$data->id)); ?>"><i class="zmdi zmdi-mood"></i> Lihat</a></td>
            </tr>
