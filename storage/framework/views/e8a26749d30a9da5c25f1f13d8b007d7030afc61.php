  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h1>Ubah Petugas Penerima</h1>
      </div>
      <div class="card-body">
        <form action="<?php echo e(route('mastertp.update',$mtp->uid)); ?>" method="post" >
          ...
          <div class="form-group <?php echo e($errors->has('nama_petugas') ? ' has-error' : ''); ?>">
            ...
            <input type="text" name="nama_petugas" class="form-control" value="<?php echo e($mtp->nama_petugas); ?>"  required>
