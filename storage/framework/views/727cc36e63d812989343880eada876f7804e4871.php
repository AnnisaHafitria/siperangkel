...
<div class="row">
     <div class="col-md-6">
        <div class="card">
            <h2 class="card-header">Export Anggota
            </h2>
            <div class="card-body">
              <a href="<?php echo e(url('downloadExcel/xlsx/anggota')); ?>"><button class="btn btn-success"><i class="zmdi zmdi-download"></i> Download Excel</button></a>
            </div>
        </div>
    </div>
</div>
