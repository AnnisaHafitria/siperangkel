    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-outline-dark btn-xs badge-pill" href="<?php echo e(route('industri.index')); ?>"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="<?php echo e(route('industri.store')); ?>" method="post" id="insert_form">
            ...
            <center>
              <table id="item_table" class="table table-hover table-bordered">
                <tr id="last" align="center">
                  <th style="background-color:#2196F3"><font color="white">Nama Industri</th>
                  <th style="background-color:#2196F3"><font color="white">Kerja Sama</th>
...
<script>
  //multiple insert
    function addrow(){
      ...
      html +='<td><input type="text" name="nama_industri[]" class="form-control"/></td>';
      html +='<td><input type="date" name="kerja_sama[]" class="form-control date"/></td>';
