    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-outline-dark btn-xs badge-pill" href="<?php echo e(route('anggota.index')); ?>"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="<?php echo e(route('anggota.store')); ?>" method="post" id="insert_form">
            ...
            <center>
              <table id="item_table" class="table table-hover table-bordered">
                <tr id="last" align="center">
                  <th style="background-color:#2196F3"><font color="white">Nomor Induk Siswa</th>
                  <th style="background-color:#2196F3"><font color="white">Nama Anggota</th>
                  <th style="background-color:#2196F3"><font color="white">Jenis Kelamin</th>
                  <th style="background-color:#2196F3"><font color="white">Jurusan</th>
                  <th style="background-color:#2196F3"><font color="white">No HP</th>
                  <th style="background-color:#2196F3"><font color="white">Alamat</th>
...
<script>
  //multiple insert
    function addrow(){
      ...
      html +='<td><input type="number" name="nis[]" class="form-control"/></td>';
      html +='<td><input type="text" name="nama_anggota[]" class="form-control"/></td>';
      html +='<td><select name="jk[]" class="form-control sl2"><option value="">Pilih Jenis Kelamin</option><option name="pr">Perempuan</option><option name="laki">Laki Laki</option></select></td>';
      html +='<td><select name="jurusan[]" class="form-control sl2"><option value="">Pilih Jurusan</option><option name="rpl">Rekayasa Perangkat Lunak</option><option name="tkr">Teknik Kendaraan Ringan</option><option name="tsm">Teknik Sepeda Motor</option></select></td>';
      html +='<td><input type="number" name="nope[]" class="form-control"/></td>';
      html +='<td><input type="text" name="alamat[]" class="form-control"/></td>';
