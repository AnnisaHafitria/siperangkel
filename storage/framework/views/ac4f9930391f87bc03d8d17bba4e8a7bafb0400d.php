  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(guests/images/tkn.jpg)">
          <div class="caption">
        ...
        <div class="item" style="background-image: url(guests/images/Jasa-Servis.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig"><span>Selamat Datang<span></h1>
            <p class="animated fadeInRightBig">Di SiPeRangKel ( Sistem Peminjaman Barang Bengkel )</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="<?php echo e(route('logout')); ?>"
              onclick="event.preventDefault();$('#logout-form').submit();">
              Keluar
            </a>
        ...
        <div class="item" style="background-image: url(guests/images/mobil0.png)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Hai <span>Pengunjung</span></h1>
            <p class="animated fadeInRightBig">Anda Berada di Halaman Website Sistem Peminjaman Barang Bengkel </p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="<?php echo e(route('logout')); ?>"
              onclick="event.preventDefault();$('#logout-form').submit();">
              Keluar
            </a>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            ...
            <p><font color="black">Teknik Kendaraan Ringan adalah ilmu yang mempelajari tentang alat-alat transportasi darat yang menggunakan mesin, terutama mobil. </p>
          </div>
        </div> 
      </div>
