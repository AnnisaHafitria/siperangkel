  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="<?php echo e(url::to('admin/laporan/anggota/detail2')); ?>"><button class="btn btn-success"><i class="zmdi zmdi-download"></i> Excel</button></a>

        <a href="<?php echo e(URL::to('admin/laporan/anggota/downloadExcel/xls')); ?>"><button class="btn btn-success"><i class="fa fa-download"></i> Excel</button></a>
        <center>
          <h1>Data Anggota</h1>
          <br>
