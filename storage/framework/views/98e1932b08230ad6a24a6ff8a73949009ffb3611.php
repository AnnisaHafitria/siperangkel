    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-dark badge-pill" href="<?php echo e(route('testimoni.index')); ?>"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="<?php echo e(route('testimoni.update',$testimoni->id)); ?>" method="post">
          <input name="_method" type="hidden" value="PATCH">
          <?php echo e(csrf_field()); ?>

          <div class="form-group">
            <label class="control-label"><font style="color:grey">Jumlah</label> 
            <input type="text" name="jumlah" value="<?php echo e($testimoni->jumlah); ?>" class="form-control" required>
          </div>
          <div class="form-group">
            <label class="control-label"><font style="color:grey">Judul</label> 
            <input type="text" name="judul" value="<?php echo e($testimoni->judul); ?>" class="form-control" required>
          </div>
          <div class="form-group">
