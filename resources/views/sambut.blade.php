...
<html lang="en">
  <head>
    ...
    <link href="{{asset('sambuts/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('sambuts/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('sambuts/css/font-awesome.css')}}" rel="stylesheet">
    <link href="{{asset('sambuts/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('sambuts/css/animate.css')}}" rel="stylesheet">
    <link href="{{asset('sambuts/css/skin-blue.css')}}" rel="stylesheet">
    <!-- Le fav -->
    <link rel="shortcut icon" href="{{asset('sambuts/ico/favicon.png')}}">
    <!--[if lt IE 9]>
    <style>
  ...
  <body data-spy="scroll" data-target=".navbar">
    <nav id="topnav" class="navbar navbar-fixed-top navbar-default" role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand">SiPeRangKel</a>
        </div>
        ...
        <div id="carousel_intro" class="carousel slide fadeing">
          <div class="carousel-inner">
            <div class="active item" id="slide_1">
              <div class="carousel-content">
                <div class="animated fadeInDownBig">
                  <h1>Sistem Peminjaman Barang Bengkel</h1>
                  <h3>Email : guest@gmail.com <br> Kata Sandi : rahasia</h3>
                </div>
                <br/>
                <a href="{{url('/login')}}" class="buttoncolor animated fadeInRightBig"><i class="fa fa-sign-in"></i> Masuk</a>
              </div>
            </div>
            <div class="item" id="slide_2">
              <div class="carousel-content">
                <div class="animated fadeInDownBig">
                  <h1>Selamat Datang <br>Di<br>Halaman Website SIPERANGKEL</h1>
                  <br>
                  <a href="{{url('/login')}}" class="buttoncolor animated fadeInRightBig"><i class="fa fa-sign-in"></i> Masuk</a>
                </div>
              </div>
            ...
            <div class="item" id="slide_3">
              <div class="carousel-content">
                <div class="animated fadeInDownBig">
                  <h1>SiPeRangKel Adalah Aplikasi Berbasis Website Yang Di Gunakan Untuk Pengelolaan Sistem Peminjaman Barang Bengkel Khususnya Pada Bengkel Otomotif Mobil.</h1>
                  <br>
                  <a href="{{url('/login')}}" class="buttoncolor animated fadeInRightBig"><i class="fa fa-sign-in"></i> Masuk</a>
                </div>
              </div>
    ...
    <section id="Section-1" class="fullbg">
      ...
      <div class="container">
        ...
        <a href="#top-section">
          <font color="white">
          <center>Ingin Tahu Informasi Selengkapnya? Masuk Sebagai Guest!.</center>
        </a>
        <!-- end row -->
      </div>
    </section>
    ...
    <section id="Section-2" class="fullbg color-white">
      ...
      <div class="container demo-3">
        ...
        <div class="row animated fadeInUpNow">
          <div class="col-sm-12 col-lg-12">
            <ul class="grid cs-style-4">
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/rpl.png')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>RPL</h3>
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tkr.png')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>TKR</h3>
                    <span>Smk Assalaam Bandung</span>
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tsm.png')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>TSM</h3>
                    <span>Smk Assalaam Bandung</span>
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/rpl2.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>RPL 2018</h3>
                    <span>Smk Assalaam Bandung</span>	
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/rpl1.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>UJIKOM RPL</h3>
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/rpl3.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>RPL 2018</h3>
                    <span>Smk Assalaam Bandung</span>			
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tkr2.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>TKR 2018</h3>
                    <span>Smk Assalaam Bandung</span>			
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tkr1.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>UJIKOM TKR</h3>
                    <span>Uji Kompetensi Keahlian Smk Assalaam Bandung</span>	
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tkr3.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>TKR 2018</h3>
                    <span>Smk Assalaam Bandung</span>
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tsm2.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>TSM 2018</h3>
                    <span>Smk Assalaam Bandung</span>			
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tsm1.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>UJIKOM TSM</h3>
                    <span>Uji Kompetensi Keahlian Smk Assalaam Bandung</span>	
              ...
              <li>
                <figure>
                  <div>
                    <img src="{{asset('sambuts/img/tsm3.jpg')}}" alt="premium-themes-templates">
                  </div>
                  <figcaption>
                    <h3>TSM 2018</h3>
                    <span>Smk Assalaam Bandung</span>
          ...
          <br>
          <a href="#top-section">
            <center>Ingin Tahu Barang Yang Bisa Di Pinjam? Masuk Sebagai Guest!.</center>
          </a>
        </div>
      </div>
    </section>
      		...
      		<div class="testimonials-slider">
      			<div class="slide">
      				<div class="testimonials-carousel-thumbnail">
      					<img width="120" alt="" src="{{asset('sambuts/img/avatar.jpg')}}">
      				</div>
        ...
        <div class="row">
          <div class="text-center color-white col-sm-12 col-lg-12">
            ...
            <p>
              ...
              SiPeRangKel. REKAYASA PERANGKAT LUNAK. Annisa Hafitria. SMK ASSALAAM BANDUNG. 2019.
            </p>
            <p>
    ...
    <script src="{{asset('sambuts/js/jquery.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('sambuts/js/bootstrap.js')}}"></script>
    <script src="{{asset('sambuts/js/jquery.parallax-1.1.3.js')}}" type="text/javascript"></script>
    <script src="{{asset('sambuts/js/jquery.localscroll-1.2.7-min.js')}}" type="text/javascript"></script>
    <script src="{{asset('sambuts/js/jquery.scrollTo-1.4.6-min.js')}}" type="text/javascript"></script>
    <script src="{{asset('sambuts/js/jquery.bxslider.min.js')}}"></script>
    <script src="{{asset('sambuts/js/jquery.placeholder.js')}}"></script>
    <script src="{{asset('sambuts/js/modernizr.custom.js')}}"></script>
    <script src="{{asset('sambuts/js/toucheffects.js')}}"></script>
    <script src="{{asset('sambuts/js/animations.js')}}"></script>
    <script src="{{asset('sambuts/js/init.js')}}"></script>
