    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-outline-dark btn-xs badge-pill" href="{{route('tentang_program.index')}}"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="{{route('tentang_program.store')}}" method="post" id="insert_form">
          {{csrf_field()}}
