    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-primary badge-pill" href="{{route('testimoni.create')}}"><i class="zmdi zmdi-plus"></i> Tambah</a>
        </div>
      </h2>
      <div class="card-body">
        <table id="myTable" class="table table-responsive table-hover table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-xs btn-outline-warning badge-pill" href="{{ route('testimoni.edit',$data->id) }}"><i class="zmdi zmdi-edit"></i> Ubah</a>
