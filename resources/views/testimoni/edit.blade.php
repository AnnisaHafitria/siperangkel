    ...
    <div class="card">
      <h2 class="card-header">
        ...
        <div class="float-right">
          <a class="btn btn-xs btn-outline-dark badge-pill" href="{{route('testimoni.index')}}"><i class="zmdi zmdi-close-circle"></i> Batal</a>
        </div>
      </h2>
      <div class="card-body">
        <form action="{{ route('testimoni.update',$testimoni->id) }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="jumlah" value="{{ $testimoni->jumlah }}" class="form-control" required>
          </div>
          <div class="form-group">
            <label class="control-label"><font style="color:grey">Judul</label> 
            <input type="text" name="judul" value="{{ $testimoni->judul }}" class="form-control" required>
          </div>
          <div class="form-group">
