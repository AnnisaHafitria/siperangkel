<html lang="en">
  ...
  <head>
    ...
    <style>
      body {
      background-image:url('/img/biru27.jpg');
  ...
  <body data-ma-theme="blue">
    <div class="login">
      ...
      <div class="login__block active" id="l-login">
          ...
          <div class="actions actions--inverse login__block__actions">
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" data-ma-action="login-switch" data-ma-target="#l-forget-password" href="#">Lupa Kata Sandi?</a>
              </div>
            </div>
          </div>
        </div>
        <form action="{{route('login')}}" method="post">
          ...
          <div class="login__block__body">
            ...
            <button  type="submit" class="btn btn-outline-primary btn-xs badge-pill"><i class="zmdi zmdi-square-right"></i> Masuk</button>
          </div>
        </form>
      </div>
      <!-- Register -->
      <div class="login__block" id="l-register">
        ...
        <form action="{{ route('register') }}" method="POST" id="registrasi">
          @csrf
          <div class="login__block__body">
            ...
            <button type="submit" class="btn btn-outline-primary btn-xs badge-pill"><i class="zmdi zmdi-check-all"></i> Daftar</button>
          </div>
        </form>
      </div>
      <!-- Forgot Password -->
      <div class="login__block" id="l-forget-password">
        ...
        <div class="login__block__body">
          ...
          <button href="index-2.html" class="btn btn-outline-primary btn-xs badge-pill"><i class="zmdi zmdi-check-square"></i> Konfirmasi</button>
        </div>
      </div>
    </div>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\RegisterStore', '#registrasi') !!}
    <!-- Mirrored from byrushan.com/projects/material-admin/app/2.1/jquery/bs4/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Apr 2018 07:07:57 GMT -->
  </body>
</html>