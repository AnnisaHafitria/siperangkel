...
<html lang="en">
  <head>
    ...
    <link href="{{asset('guests/css/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('guests/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('guests/css/lightbox.css')}}" rel="stylesheet">
    <link href="{{asset('guests/css/main.css')}}" rel="stylesheet">
    <link id="css-preset" href="{{asset('guests/css/presets/preset1.css')}}" rel="stylesheet">
    ...
    <link rel="icon" href="{{asset('guests/images/assalaam.png')}}">
  ...
  <body>
        ...
        <div class="carousel-inner">
          <div class="item active" style="background-image: url(guests/images/mobil3.png)">
            <div class="caption">
              ...
              <a data-scroll class="btn btn-start animated fadeInUpBig" href="{{url('/login')}}" class="buttoncolor animated fadeInRightBig"><i class="fas fa-sign-in-alt"></i> Masuk</a>
            </div>
          </div>
    ...
    <section id="about-us" class="parallax">
      <div class="container">
        <div class="row">
          @foreach (\App\TentangProgram::all() as $data )
          <div class="col-sm-6">
    ...
    <section id="portfolio">
      ...
      <div class="container-fluid">
        <div class="row">
          @foreach (\App\Barang::all() as $data )
          <div class="col-sm-3">
            <div class="folio-item wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="folio-image">
                <img class="img-responsive" src="{{asset('assets/img/foto/'.$data->foto)}}" alt="" style="height: 300px;">
              </div>
              <div class="overlay">
                <div class="overlay-content">
                  <div class="overlay-text">
                    <div class="folio-info">
                      ...
                      <p>Persediaan {{$data->persediaan}} {{$data->satuan}}</p>
                    </div>
                    <div class="folio-overview">
                      <span class="folio-link"><a class="folio-read-more" href="#" data-single_url="portfolio-single.html" ><i class="fa fa-link"></i></a></span>
                      <span class="folio-expand"><a href="{{asset('assets/img/foto/'.$data->foto)}}" data-lightbox="portfolio"><i class="fa fa-search-plus"></i></a></span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section id="team">
      <div class="container">
        ...
        <div class="team-members">
          <div class="row">
            @foreach( \App\Kontak::all() as $data)
            <div class="col-sm-3">
              <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="500ms">
                <div class="member-image">
                  <img class="img-responsive" src="{{asset('assets/img/foto/'.$data->foto)}}" alt="">
                </div>
                <div class="member-info">
                  <h3>{{$data->nama_kontak}}</h3>
                  <h4>{{$data->jabatan}}</h4>
                  <b>No HP :</b> {{$data->nope}}<br>
            ...
            <!-- <div class="col-sm-3">
              <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="500ms">
                <div class="member-image">
                  <img class="img-responsive" src="{{asset('guests/images/team/rokib.png')}}" alt="">
                </div>
                <div class="member-info">
            ...
            <div class="col-sm-3">
              <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="700ms">
                <div class="member-image">
                  <img class="img-responsive" src="{{asset('guests/images/team/kurniawan.jpg')}}" alt="">
                </div>
                <div class="member-info">
                  <h3>Kurniawan</h3>
            ...
            <div class="col-sm-3">
              <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="900ms">
                <div class="member-image">
                  <img class="img-responsive" src="{{asset('guests/images/team/wahyu.png')}}" alt="">
                </div>
                <div class="member-info">
            ...
            <div class="col-sm-3">
              <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="1100ms">
                <div class="member-image">
                  <img class="img-responsive" src="{{asset('guests/images/team/adrian.jpg')}}" alt="">
                </div>
                <div class="member-info">
                  <h3>Adrian Mahmud</h3>
      ...
      <div id="contact-us" class="parallax">
        <div class="container">
          ...
          <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="row">
                @foreach (\App\Aturan::all() as $data)
                <div class="col-sm-6">
    ...
    <section id="blog">
      <div class="container">
        ...
        <div class="blog-posts">
          <div class="row">
            @foreach(\App\Industri::all() as $data)
            <div class="col-sm-3 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
              <div class="post-thumb">
                <img class="img-responsive" src="{{asset('assets/img/foto/'.$data->foto)}}" style="max-height:200px;max-width:200px;margin-top:10px;" alt=""> 
                <div class="post-icon">
                  <i class="fa fa-picture-o"></i>
                </div>
              </div>
              <div class="entry-header">
                <h3>{{$data->nama_industri}}</h3>
                <span class="date">{{$data->kerja_sama}}</span>
    ...
    <script type="text/javascript" src="{{asset('guests/js/jquery.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script type="text/javascript" src="{{asset('guests/js/jquery.inview.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/wow.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/mousescroll.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/smoothscroll.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/jquery.countTo.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/lightbox.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('guests/js/main.js')}}"></script>
  </body>
</html>